    ...
    <section className="mt-20">
        ...
        <div className="rounded-3xl border border-[var(--border)] bg-gradient-to-br from-amber-50 via-white to-white p-8 shadow-lg">
          <div className="text-center">
            ...
            <div className="mt-4 flex items-center justify-center gap-2 text-sm">
              ...
              <span className="font-medium text-green-700">All Verified Purchases</span>
            </div>
          </div>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
        {reviews.map((review) => (
          <div
            key={review.id}
            className="group rounded-3xl border border-[var(--border)] bg-white p-6 shadow-sm transition-all hover:shadow-xl hover:-translate-y-1"
          >
            {/* Header */}
      ...
      <div className="mt-8 text-center">
        <button className="rounded-full border-2 border-[var(--border)] bg-white px-8 py-3 font-semibold text-[var(--text-primary)] transition-all hover:border-[var(--primary)] hover:bg-[var(--primary)] hover:text-white hover:scale-105">
          Load More Reviews
        </button>
      </div>
    </section>
