      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl">
          ...
          <h2 className="mt-3 text-3xl font-bold leading-tight text-[var(--text-primary)] md:text-4xl">
            Growing Local Agriculture Through Digital Commerce
          </h2>

          <p className="mt-5 text-[15px] leading-8 text-[var(--text-secondary)] md:text-base">
            F2CMARKET continues to connect farmers and consumers through a
            transparent marketplace focused on freshness, sustainability, and
            fair pricing.
          </p>
        </div>
