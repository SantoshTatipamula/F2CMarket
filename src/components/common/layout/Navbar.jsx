          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            {!user && (
              <>
                ...
                <Link
                  to="/register"
                  className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[var(--primary)] text-white hover:bg-[var(--primary-hover)] transition text-sm font-medium"
                >
                  Register
                </Link>
              </>
          ...
          {!user && (
            <div className="flex flex-col gap-3 mt-4">
              <Link
                to="/login"
                onClick={closeMenu}
                className="flex items-center justify-center gap-2 px-4 py-2 rounded-xl border border-[var(--border-strong)] hover:bg-[var(--surface-2)] transition"
              >
                <User size={18} />
                Login
              </Link>
              ...
              <Link
                to="/register"
                onClick={closeMenu}
                className="flex items-center justify-center gap-2 px-4 py-2 rounded-xl bg-[var(--primary)] text-white hover:bg-[var(--primary-hover)] transition"
              >
                Register
              </Link>
            </div>
